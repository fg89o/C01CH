 ...
 * power monitor devices, see https://github.com/SV-Zanshin/INA/wiki or the code below for a full
 ...
 * decives using the industry standard I2C protocol.
 *
 ...
 * 1.0.2   | 2018-07-22 | SV-Zanshin  | Issue #11. Reduce EEPROM footprint. Removed "deviceName",
                                        8B. Changed datatype in structure to bit-level length defs,
