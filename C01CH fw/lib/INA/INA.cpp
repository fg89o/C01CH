...
**********************************************************************************************/
    ...
    EEPROM_Size = 512 + EEPROM_Offset;
    EEPROM.begin(EEPROM_Size);                 // If ESP32 then allocate 512 Bytes
    maxDevices = EEPROM_Size / sizeof(inaEE);  // and compute number of devices
